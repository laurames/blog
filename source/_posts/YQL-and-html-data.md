...
description: "This is a project for a local church organisation for fetching their event data onto a big display monitor. We are using yahoo's YQL queries to get xml data that is then converted into a JSON array string. This is an app that runs on the browser."
categories:
  - featured
tags:
  - YQL
